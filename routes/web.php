...
Route::middleware(['auth'])->group(function () {
    ...
    //My Account Shipping Address Page
    ...
    Route::post('account-address/update', [UserController::class, 'update_address'])->name('user.address.update');
    //End My Account Page

    //Account Dashboard Page
    Route::get('/account-details', [UserController::class, 'showAccountDetails'])->name('user.account.details');
...
Route::middleware(['auth', AuthAdmin::class])->group(function () {
    ...
    //End Slider page authentication

    //contact page authentication
    Route::get('/admin/contact',[AdminController::class,'contacts'])->name('admin.contacts');
    Route::delete('/admin/contact/{id}/delete',[AdminController::class,'contact_delete'])->name('admin.contacts.delete');
    //End contact page authentication

    //search page authentication
    Route::get('/admin/search', [AdminController::class,'search'])->name('admin.search');
    //End search page authentication

    //account page authentication
    Route::get('/admin/account-details', [AdminController::class, 'showAccountDetails'])->name('admin.account.details');
...
Route::middleware(['auth'])->group(function () {
    ...
    Route::post('/checkout/place-order', [CartController::class, 'place_an_order'])
        ->name('cart.place.an.order');

    Route::get('/payment/sslcommerz/initiate/{orderId}', [SslCommerzController::class, 'initiate'])
        ->name('payment.sslcommerz.initiate');
    ...
    Route::get('/order_confirmation', [CartController::class, 'order_confirmation'])
