...
<main>
    ...
    <div class="container mw-1620 bg-white border-radius-10">
      ...
      <section class="hot-deals container">
        ...
        <div class="row">
          <div
            ...
            <h2>Summer Sale</h2>
            <h2 class="fw-bold">Pick Your Luck</h2>
                  ...
                  <div class="swiper-slide product-card product-card_style3">
                    <div class="pc__img-wrapper">
                      <a href="{{ route('shop.product.details',['product_slug'=>$sproduct->slug]) }}">
                        ...
                        {{-- <img loading="lazy" src="{{ asset('uploads/products')}}/{{ $sproduct->image }}" width="258" height="313" alt="{{ $sproduct->name }}" class="pc__img pc__img-second"> --}}
                      </a>
                    </div>
      ...
      <section class="category-banner container">
        <div class="row">
          @foreach($fsproducts as $fsproduct )
          <div class="col-md-6">
            <div class="category-banner__item border-radius-10 mb-5">
              <img loading="lazy" class="h-auto" src="{{ asset('uploads/products')}}/{{ $fsproduct->image }}" width="690" height="665"
                alt="" />
              <div class="category-banner__item-mark">
                Starting at {{ $fsproduct->sale_price }}
              </div>
              <div class="category-banner__item-content">
                <h3 class="mb-0">{{ $fsproduct->category->name }}</h3>
                <a href="{{ route('shop.product.details',['product_slug'=>$fsproduct->slug]) }}" class="btn-link default-underline text-uppercase fw-medium">Shop Now</a>
              </div>
            </div>
          </div>                      
          @endforeach
