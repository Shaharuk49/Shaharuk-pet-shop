...
<head>
    ...
    <meta name="author" content="Md Fawjul Azim" />
                    ...
                    <div class="center">
                        ...
                        <div class="center-item">
                            <ul class="menu-list">
                                ...
                                <li class="menu-item">
                                    <a href="{{ route('admin.account.details') }}" class="">
                ...
                <div class="section-content-right">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end has-content"
                                            ...
                                            <li>
                                                ...
                                                <a href="{{ route('logout') }}" class="user-item" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                                                    <div class="icon"><i class="icon-log-out"></i></i></div>
                                                    <div class="body-title-2">Log Out</div>
                                                </a>
                                            </li>
                                        </ul>
                    ...
                    <div class="main-content">
                        ...
                        <div class="bottom-page">
                            <div class="body-text">Copyright © 2024 Shaaruk</div>
                        </div>
                    </div>
