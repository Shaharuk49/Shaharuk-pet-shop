            ...
            <div class="col-lg-12">
                <div class="page-content my-account__edit">
                    <div class="my-account__edit-form">
                        ...
                        @endif
                        <form name="account_edit_form" action="{{ route('admin.account.update') }}" method="POST" class="form-new-product form-style-1 needs-validation" novalidate="">
                            @csrf
                            ...
                            <fieldset class="name">
                                ...
                                <input class="flex-grow" type="text" placeholder="Email Address" value="{{ $user->email }}" aria-required="true" readonly>
                            </fieldset>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <fieldset class="name">
                                        ...
                                        <input class="flex-grow" type="password" placeholder="Confirm new password" id="new_password_confirmation" name="new_password_confirmation">
