        ...
        <div class="accordion" id="price-filters">
          <div class="accordion-item mb-4">
            ...
            <div id="accordion-filter-price" class="accordion-collapse collapse show border-0"
              ...
              <input class="price-range-slider" type="text" name="price_range" id="test" value="" data-slider-min="1" data-slider-max="10000" data-slider-step="5" data-slider-value="[{{ $min_price }},{{ $max_price }}]" data-currency="৳" />
                ...
                <div class="slide-split_text position-relative d-flex align-items-center"
                  ...
                  <div class="slideshow-text container p-3 p-xl-5">
                    <h2
                      ...
                      Shaharuk Pet Shop <br /><strong>EASY SOLUTION</strong></h2>
                    <p class="mb-0 animate animate_fade animate_btt animate_delay-5">"Shaharuk Pet Shop Shop Easy Solution is an online store that offers a wide range of products for easy purchase. With a user-friendly interface, it provides a seamless shopping experience. Customers can easily browse, select, and buy products with just a few clicks."</h6>
                  </div>
                </div>
                <div class="slide-split_media position-relative">
                  <div class="slideshow-bg" style="background-color: #f5e6e0;">
                    <img loading="lazy" src="{{ asset('assets/images/shop/ChatGPT Image Dec 26, 2025, 09_12_04 PM.png') }}" width="630" height="450"
                      alt="Emil Shop" class="slideshow-bg__img object-fit-cover" />
                  </div>
                </div>
              </div>
            </div>
                ...
                <div class="slide-split_text position-relative d-flex align-items-center"
                  ...
                  <div class="slideshow-text container p-3 p-xl-5">
                    <h2
                      class="text-uppercase section-title fw-normal mb-3 animate animate_fade animate_btt animate_delay-2">
                     Shaharuk Pet SHOP <br /><strong>EASY SOLUTION</strong></h2>
                    <p class="mb-0 animate animate_fade animate_btt animate_delay-5">"Shaharuk Pet Shop Easy Solution is your go-to online shop for a hassle-free shopping experience. Featuring a simple, intuitive design, it lets customers explore products and make purchases effortlessly. Enjoy secure and quick transactions, all from the comfort of your home."</h6>
                  </div>
                </div>
                <div class="slide-split_media position-relative">
                  <div class="slideshow-bg" style="background-color: #f5e6e0;">
                    <img loading="lazy" src="{{ asset('assets/images/shop/ChatGPT Image Dec 26, 2025, 09_15_40 PM.png') }}" width="630" height="450"
                      alt="Women's EASY SOLUTION" class="slideshow-bg__img object-fit-cover" />
                  </div>
                </div>
              </div>
            </div>
                ...
                <div class="slide-split_text position-relative d-flex align-items-center"
                  ...
                  <div class="slideshow-text container p-3 p-xl-5">
                    <h2
                      class="text-uppercase section-title fw-normal mb-3 animate animate_fade animate_btt animate_delay-2">
                     Shaharuk Pet SHOP <br /><strong>EASY SOLUTION</strong></h2>
                    <p class="mb-0 animate animate_fade animate_btt animate_delay-5">"Shaharuk PetL Shop Easy Solution, shopping is made simple and convenient. The website offers a wide selection of products, designed for ease of use and smooth navigation. Whether you're browsing or buying, the process is quick, secure, and customer-focused."</h6>
                  </div>
                </div>
                <div class="slide-split_media position-relative">
                  <div class="slideshow-bg" style="background-color: #f5e6e0;">
                    <img loading="lazy" src="{{ asset('assets/images/shop/ChatGPT Image Dec 26, 2025, 09_17_58 PM.png') }}" width="630" height="450"
                      alt="Women's EASY SOLUTION" class="slideshow-bg__img object-fit-cover" />
                  </div>
                </div>
              </div>
          ...
          <div class="product-card-wrapper">
            <div class="product-card mb-3 mb-md-4 mb-xxl-5">
              <div class="pc__img-wrapper">
                ...
                <a href="{{ route('cart.index') }}" class="pc__atc btn anim_appear-bottom btn position-absolute border-0 text-uppercase fw-medium" data-aside="cartDrawer btn-warning mb-3"> Go To Cart</a>
                @else
...
$(document).ready(function () {         
      $("#test").on('change',function(){
          $("#hdnMinPrice").val($(".price-range-slider").val().split(',')[0]);
          $("#hdnMaxPrice").val($(".price-range-slider").val().split(',')[1]);
          // console.log();
          setTimeout(() => {           
            $("#frmFilter").submit();
          }, 3000);
